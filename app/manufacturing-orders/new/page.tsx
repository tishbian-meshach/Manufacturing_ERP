    ...
    return (
      <div className="fixed inset-0 bg-background/80 backdrop-blur-sm z-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-xl text-muted-foreground font-medium">Loading manufacturing order data...</p>
          <p className="text-sm text-muted-foreground mt-2">Please wait while we fetch items and BOMs</p>
        </div>
      </div>
    )
  }
